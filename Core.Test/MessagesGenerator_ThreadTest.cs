...
namespace Core.Test {
	[TestClass]
	public class MessagesGenerator_ThreadTest {
		...
		public MessagesGenerator_Thread messagesGenerator_Task;
		...
		public void SetUp() {
			...
			messagesGenerator_Task = new MessagesGenerator_Thread(fakeMobilePhone, messagesGenerationInterval);
		}
